                                                ...
                                                <div class="col-12 col-md-4 my-2">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <a href="?p=materi&keyword=<?php echo $row['course_name']?>"><span class="w-75 badge badge-pill badge-success text-truncate z-depth-0">
                                            ...
                                            <div class="col-12 col-md-4 my-2">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class=" view overlay card-body">
                                                        <!-- Title -->
                                                        <h6 class="card-title"><strong><?php echo $result['material_subject'] ?></strong></h6>
                                                        <a href="?p=materi&keyword=<?php echo $result['course_name']?>"><span class="w-75 badge badge-pill badge-success text-truncate z-depth-0">
                                                        <?php echo $result['course_name']?></span></span></a>
                                                        <hr class="mt-1">
                                                        <div class="row mb-3">
                                                            <p class="col-md-6 mb-0 font-small dark-grey-text text-truncate"><i class="fas fa-download"></i>
